...
# Now convert the saved model to TFLite format
import tensorflow as tf
...
# 💡 Enable select TF ops to support LSTM and other dynamic ops
#converter.target_spec.supported_ops = [
 #   tf.lite.OpsSet.TFLITE_BUILTINS,
  #  tf.lite.OpsSet.SELECT_TF_OPS
#]
# ❗ Avoid lowering TensorList ops (they are not TFLite compatible yet)
...
with open('update_model.tflite', 'wb') as f:
    f.write(tflite_model)

print("Model converted to TFLite and saved as update_model.tflite")